...
kinesis_stream_name = 'ecommerce-raw-user-activity-pp-stream1'
...
# Run stream:
for i in range(0, 5):
    stream_data_simulator(input_s3_bucket="ecommerce-raw-pp-dev",
                          input_s3_key="ecomm_user_activity_sample/2019-Oct-sample.csv")
